...
{
    class EnableFarmFeatureCommand : CommandBase
    {
        private readonly IFeatureService _featureService;

        public EnableFarmFeatureCommand(Options options, IFeatureService featureService) 
            : base(options)
        {
        ...
        public override async Task<int> Execute()
        {
            ...
            await _featureService.EnableFarmFeatureAsync(feature.Id);
