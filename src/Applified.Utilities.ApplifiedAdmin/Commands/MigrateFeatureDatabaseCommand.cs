...
{
    class MigrateFeatureDatabaseCommand : CommandBase
    {
        private readonly IFeatureService _featureService;

        public MigrateFeatureDatabaseCommand(
        ...
        public override async Task<int> Execute()
        {
            ...
            var configuration = instance.GetMigrationsConfiguration();

            if (configuration == null)
            {
                Console.WriteLine("Feature contains no migrations!");
                return 0;
            }
