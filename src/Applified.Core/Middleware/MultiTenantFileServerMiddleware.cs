...
{
    public class MultiTenantFileServerMiddleware : AbstractNotificationSubscriber, IDynamicRegistrationDelegate
    {
        ...
        public MultiTenantFileServerMiddleware(Func<IDictionary<string, object>, Task> nextFunc, SharedOptions sharedOptions, string workingDirectory)
        {
            _nextFunc = nextFunc;
        ...
        public async Task Invoke(IDictionary<string, object> environment)
        {
            ...
            var activeDeploymentId = currentApplication.DeploymentId;
        ...
        public void InterceptRequestScope(IUnityServiceProvider provider, IOwinContext context)
        {
            ...
            if (container != null)
            {
                container.RegisterInstance<INotificationSubscriber>("MultiTenantFileServerMiddleware", this);
            }
        }
    }
}